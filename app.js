document.addEventListener('DOMContentLoaded', () => {
    ...
    // add an onClick to each square in your grid.
        squares[i].onclick = function(){
            //if the squares below your current sqaure is taken, you can go ontop of it.
...
// Check the board for a win or lose
 ...
 function checkBoard(){
    ...
    // Now check to see if they all habe the class name of player-two
    ...
    // Add and eventListener to each square that will trigger the check board function
